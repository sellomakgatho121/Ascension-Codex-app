export interface DnaStrandInfo {
  name: string;
  scientificType: string;
  spiritualType: string;
  dimensions: string;
  harmonicUniverse: string;
  chakras: string;
  consciousness: string;
  description: string;
  keyPoints: string[];
  energeticSynthesis: string;
  ascensionGlossary: string;
  activation: string;
}

export const DNA_STRAND_DATA: Record<number, DnaStrandInfo> = {
  2: {
    name: "Double Helix",
    scientificType: "B-DNA",
    spiritualType: "Base Physical Matrix",
    dimensions: "1D-2D",
    harmonicUniverse: "First Harmonic Universe (Partial)",
    chakras: "Root (1D), Sacral (2D)",
    consciousness: "Physical Body Consciousness",
    description: "The current human DNA operates with only 2 active strands out of the original 12 Strand Silicate Matrix. This represents the base physical incarnation level.",
    keyPoints: [
      ...
      "Holds basic survival and reproductive functions"
    ],
  ...
  3: {
    ...
    dimensions: "1D-2D-3D",
    harmonicUniverse: "First Harmonic Universe (Complete)",
    chakras: "Root (1D), Sacral (2D), Solar Plexus (3D)",
    consciousness: "Personality Matrix - Incarnated Human",
    ...
    keyPoints: [
      ...
      "Foundation for ego transcendence"
    ],
  ...
  4: {
    name: "G-Quadruplex",
    scientificType: "Tetraplex / Four-Strand",
    spiritualType: "Heart Bridge - Astral Gateway",
    dimensions: "4D (Astral Plane)",
    harmonicUniverse: "Second Harmonic Universe (Entry)",
    chakras: "Heart (4D)",
    consciousness: "Soul Matrix - Astral Consciousness",
    ...
    keyPoints: [
      ...
      "Begins dissolution of ego boundaries"
    ],
  ...
  5: {
    name: "Pentaplex",
    scientificType: "Five-Strand Complex",
    spiritualType: "Higher Mind Activation",
    dimensions: "5D (Archetypal Mind)",
    harmonicUniverse: "Second Harmonic Universe",
    chakras: "Throat (5D)",
    consciousness: "Soul Expression - Creative Voice",
    ...
    keyPoints: [
      ...
      "Manifestation through sound and word"
    ],
  ...
  6: {
    ...
    spiritualType: "Third Eye Activation - Celestial Vision",
    dimensions: "6D (Celestial Plane)",
    harmonicUniverse: "Second Harmonic Universe (Complete)",
    chakras: "Third Eye (6D)",
    consciousness: "Soul Integration - Intuitive Knowing",
  ...
  7: {
    ...
    spiritualType: "Monadic Integration Begins",
    dimensions: "7D (Ketheric Template)",
    harmonicUniverse: "Third Harmonic Universe (Entry)",
    chakras: "Crown (7D)",
    consciousness: "Monad - Oversoul Connection",
    ...
    keyPoints: [
      ...
      "Beginning of Avatar consciousness"
    ],
  ...
  8: {
    ...
    spiritualType: "Monadic Body Integration",
    dimensions: "8D (Monadic Core)",
    harmonicUniverse: "Third Harmonic Universe",
    chakras: "Higher Crown (8D)",
    consciousness: "Monad - Group Avatar Consciousness",
    ...
    keyPoints: [
      ...
      "Transcendence of individual karma"
    ],
  ...
  9: {
    ...
    harmonicUniverse: "Third Harmonic Universe (Complete)",
    chakras: "Universal Mind (9D)",
    consciousness: "Christos-Sophia - Cosmic Christ Consciousness",
    description: "Nine-strand DNA completes the Monadic Matrix, embodying Cosmic Christ-Sophia consciousness and full connection to the Gaian crystalline matrix.",
    keyPoints: [
      ...
      "Preparation for Avatar Christos body"
    ],
  ...
  10: {
    ...
    harmonicUniverse: "Fourth Harmonic Universe (Entry)",
    chakras: "Solar Star (10D)",
    consciousness: "Avatar Christos - Solar Consciousness",
    ...
    keyPoints: [
      ...
      "Planetary grid keeper abilities"
    ],
  ...
  11: {
    name: "11-Strand DNA",
    scientificType: "Complex Multi-Strand",
    spiritualType: "Galactic Logos Integration",
    dimensions: "11D (Galactic Core)",
    harmonicUniverse: "Fourth Harmonic Universe",
    chakras: "Galactic Center (11D)",
    consciousness: "Galactic Avatar - Krystal Consciousness",
    ...
    keyPoints: [
      ...
      "Preparation for full Silicate Matrix"
    ],
  ...
  12: {
    name: "12-Strand DNA",
    scientificType: "Silicate Matrix / Diamond Sun",
    spiritualType: "Full Christos Avatar - Ascended Master",
    dimensions: "12D (Universal Logos)",
    harmonicUniverse: "Fourth Harmonic Universe (Complete)",
    chakras: "Universal Gateway (12D)",
    consciousness: "Universal Christos - Ascended Master",
    ...
    keyPoints: [
      ...
      "Ability to transmute and ascend at will",
      "Freedom from reincarnation cycle",
      "Stargate passage abilities"
    ],
    ...
    ascensionGlossary: "The original human DNA pattern arranged into 12 dimensionalized mathematical programs. Each strand composed of 12 base magnetic female codes (Mions) and 12 base-electrical male acceleration codes (Dions). The complete Silicate Matrix represents full consciousness freedom, with Inner Christos fully activated and Sacred Crystal Heart flowering.",
    activation: "The ultimate goal of spiritual ascension. Achieved through complete integration of all dimensional layers, embodiment of universal love-wisdom, and alignment with the Cosmic Kryst-Krystallah blueprint. Represents liberation from the Prison Planet and freedom to traverse dimensions."
  }
};
